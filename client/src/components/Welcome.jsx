...
const Input = ({placeholder, name, type, value, handleChange}) => (
    <input 
        ...
        className="my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none blue-glassmorphism text-sm "
    />
        ...
        <div className="flex w-full justify-center item-center">
            <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justofy-start flex-col mf:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/11 w-11/12 text-base">
